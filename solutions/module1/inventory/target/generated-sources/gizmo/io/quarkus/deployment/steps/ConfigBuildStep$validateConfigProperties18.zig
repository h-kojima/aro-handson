// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties18
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties18#deploy_0
    RETURN
    ** label2
