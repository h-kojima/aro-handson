// Class: io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits16
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits16#deploy_0
    RETURN
    ** label2
