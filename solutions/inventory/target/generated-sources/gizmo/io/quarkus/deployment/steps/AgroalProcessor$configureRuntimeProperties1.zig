// Class: io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties1#deploy_0
    RETURN
    ** label2
