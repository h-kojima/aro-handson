// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection19
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection19#deploy_0
    RETURN
    ** label2
