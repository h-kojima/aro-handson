// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean9
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean9#deploy_0
    RETURN
    ** label2
